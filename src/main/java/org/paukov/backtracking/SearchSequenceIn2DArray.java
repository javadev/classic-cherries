 ...
 *
 * Given A is a matrix and S is an array of integers, we say S
 * occurs in A if you can start from some entry in A and traverse adjacent entries in A in the order
 * prescribed by S. Adjacent entries are top, bottom, left and right ones. It is possible to visit
 * an entry in the matrix A more than once.
 *
 * For example, if A = [1 2 3 3 4 5 5 6 7] S = [1 3 4 6]
